...
// - https://github.com/firebase/firebase-js-sdk/blob/9f109f85ad0d99f6c13e68dcb549a0b852e35a2a/packages/functions/src/api/error.ts
export function retrieveStatusCode(statusTxt) {
    // Make sure any successful status is OK.
    var regexResult = /\[code\=([\w-]*)/g.exec(statusTxt);
    var status = Array.isArray(regexResult) && regexResult[1];
    if (!status) {
        logError('unknown StatusCode ', { statusTxt: statusTxt });
    }
    switch (status) {
...
//# sourceMappingURL=status-code-translator.js.map